...
<html lang="en">
  ...
  <link rel="shortcut icon" href="assets/images/bosman1.png" type="">
    ...
    <header class="header_section">
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container">
          <a class="navbar-brand" href="beranda">
            <img src="assets/images/logo_bosman.png" height="70" alt="" >
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>styling">Styling</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url()?>order">Order</a>
              </li>
              <li class="nav-item position-relative">
  <a class="nav-link d-flex align-items-center" href="<?= base_url() ?>keranjang" style="text-decoration: none;">
